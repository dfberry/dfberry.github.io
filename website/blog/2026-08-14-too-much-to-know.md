---
slug: /2026-08-14-writing-history-of-software
date: 2026-08-14
canonical_url: https://dfberry.github.io/blog/2026-08-14-writing-history-of-software
custom_edit_url: null
sidebar_label: "2026.08.14 Project memory"
...
image: ./media/2026-08-14-too-much-to-know/watercolor-01-hero.png
---

![Woman architect at forked road with project book notebook and Squad car symbolizing partnership](./media/2026-08-14-too-much-to-know/watercolor-01-hero.png)
...
I can use something like [spec-kit brownfield extension](https://github.com/github/spec-kit) to come up with the main artifacts, then supplement with [Graphify](https://github.com/Graphify-Labs/graphify) queries to solidify the details of the current state. This may seem like a lot of work, but with agents and skills, this process is quickly completed. The project _book_, as a living artifact, should now be ready to review. It should include:
...
To keep that from becoming chaos, I've started using a few simple guiding principles.
...
![Woman at workbench sorting glowing decision cards into operational memory and institutional memory containers](./media/2026-08-14-too-much-to-know/watercolor-03-squad-vs-book.png)
...
Some of the most important decisions happened in Teams or Slack threads, in meeting transcripts, and in docs that never made it to a pull request. If I only index code, I get implementation detail. If I include communication and docs, I get intent.
...
![Woman transforming from dusty software archaeology ruins to cultivated garden of organized project knowledge](./media/2026-08-14-too-much-to-know/watercolor-02-archaeology-to-stewardship.png)

## Operationalizing this

I needed this to be more than a good idea, so I turned it into a repeatable weekly practice.
