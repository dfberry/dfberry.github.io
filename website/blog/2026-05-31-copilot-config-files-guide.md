...
![Configuration files structure across the five .github families](./media/2026-05-31-copilot-config-files-guide/diagram-2-configuration-files-structure.svg)
...
![Woman comparing two books — one simple, one with tabbed sections and tools — representing skills vs prompts](./media/2026-05-31-copilot-config-files-guide/watercolor-4-skills-vs-prompts.png)
...
![Decision tree for choosing between skills, official prompts, prompt docs, or no file](./media/2026-05-31-copilot-config-files-guide/diagram-3-skills-vs-prompts-decision-tree.svg)
...
![Sequence diagram for the Azure SDK architecture review workflow](./media/2026-05-31-copilot-config-files-guide/diagram-4-azure-sdk-workflow-trigger.svg)
...
![Decision tree for placing work in instructions, agents, skills, prompts, or workflows](./media/2026-05-31-copilot-config-files-guide/diagram-5-file-placement-decision-tree.svg)
...
![Woman placing the final piece into a five-panel layout at a workshop bench — all the config files fitting together](./media/2026-05-31-copilot-config-files-guide/watercolor-5-putting-it-together.png)
