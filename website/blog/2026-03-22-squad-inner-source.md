...
When a maintainer commits their `.squad/`, contributors don't clone just code — they clone the collaboration infrastructure. Specifically, three things:
